...
@Disabled
public class AerospikeEventualDebugGraphTest extends JanusGraphEventualGraphTest {
    ...
    //TODO can't get a glue why it should fail
    @Ignore
    @Override
    @Test
    ...
    //TODO TTL not supported currently. think about
    @Ignore
    @Override
    @Test
